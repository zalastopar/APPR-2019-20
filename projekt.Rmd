...
```
Spodnji graf prikazuje povezavo med prihodkom in proračunom ter povezavo med dolžino filma ter proračunom.

```{r analiza5, echo=FALSE, fig.align='center', message=FALSE, warning=FALSE, fig.cap='Graf prihodkov in proračuna'}
analiza5  
```
