...
```{r graf1, echo=FALSE, message=FALSE, warning=FALSE, fig.cap='Graf proračuna, dolžine in ocene filma'}
graf1
```

Spodnji graf prikazuje število filmov, posnetih v posameznem letu.

```{r graf2, echo=FALSE, message=FALSE, warning=FALSE, fig.cap='Graf posnetih filmov po letih'}
graf2
```
